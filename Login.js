    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.headingMessages}> 
          <Text style={{fontSize: 32, paddingBottom: 20}}>Welcome Back</Text>
          <Text style={{fontSize: 28, textAlign:'center'}}>Log in to access your account</Text>
        </View>
        ...
        <View style={styles.additionalOptions}> 
           ...
           <TouchableOpacity>
              <Text style={{color:'#40C9E8'}}> Sign up </Text>
           </TouchableOpacity>
        </View>
      </View>
    );
